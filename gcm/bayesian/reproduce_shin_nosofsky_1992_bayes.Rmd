...
init_values <- list(
  list(c = 4, w = c(0.5, 0.2, -0.1, 0.1, -0.2), k = 0.5)
  , list(c = 2, w = c(0, 0, 0, 0, 0), k = 0.3)
  , list(c = 3, w = c(0.25, 0.3, -0.3, -0.15, -0.05), k = 0.7)
)
...
knitr::kable(summary(gcm_samples)[c("c", paste0("wj[", 1:6, "]"), "k"), ])
```
